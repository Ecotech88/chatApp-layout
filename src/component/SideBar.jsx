...
<<<<<<< HEAD
      <div className='flex-grow mt-3 overflow-y-auto border-b-2 md:w-full lg:w-auto hide-scrollbar' style={{ maxHeight: 'calc(100vh - 200px)' }}>
        {Users.map((user, id) => (
...
>>>>>>> 9f9cf46f4406411fe973eddfb470e8f907620bbb
            <div className='flex items-center gap-5'>
              <img className='w-12 h-12 md:w-14 md:h-14 object-cover rounded-full' src={user.images} alt="" />
              <div className='flex flex-col justify-center'>
                <h2 className='font-bold text-sm md:text-lg lg:text-2xl'>{user.name}</h2>
                <p className='text-xs md:text-sm lg:text-lg text-gray-600'>{user.greeting}</p>
              </div>
            </div>
